...
export class GenesysType {
  ...
  _read() {
    ...
    this.muPropertyCount = (this._io.readU2be()) as any
...
export namespace GenesysType {
  export class GenesysNativetypeEnumerationData {
    ...
    _read() {
      this.mpBaseTypePtr = (this._io.readU4be()) as any
      this.muBaseTypeVersion = (this._io.readU4be()) as any
      ...
      this.muVersion = (this._io.readU4be()) as any
      this.muId = (this._io.readU4be()) as any
      this.muSize = (this._io.readU4be()) as any
      this.maReserved = [];
      for (let i = 0; i < 3; i++) {
...
export namespace GenesysType {
  export class GenesysTypeHash {
    ...
    _read() {
      this.hash = (this._io.readU4be()) as any
      this.padding = (this._io.readU4be()) as any
      this.value = (this._io.readF4be()) as any
    }
...
export namespace GenesysType {
  export class GenesysTypeEntry {
    ...
    _read() {
      ...
      this.position = (this._io.readU4be()) as any
...
export namespace GenesysType {
  export class GenesysProperty {
    ...
    _read() {
      ...
      this.mpArrayCountPropertyPtr = (this._io.readU4be()) as any
      this.muId = (this._io.readU4be()) as any
      this.muTypeSize = (this._io.readU4be()) as any
      this.muOffset = (this._io.readU4be()) as any
      this.muCount = (this._io.readU2be()) as any
